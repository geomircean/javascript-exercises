export function iterate() {
  ...
  */
  ...
  return { intitialArray, forEachArray, mapArray };
}
...
export function duplicates(array) {
  /** TODO: count the number of duplicate elements in an array */
...
export function rotate(array, positions) {
  /** TODO: Rotate elements of an array by the number of positions */
  const rotatedArray = [];
  return rotatedArray;
}
...
export function shoppingSpree(whishlist) {
  /** TODO:
